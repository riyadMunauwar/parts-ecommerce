                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-1">
                                <span class="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">Paid</span>
                            </td>
                            ...
                            <td class="px-4 py-1">
                                <div class="flex items-center gap-1 justify-end">
                                    <button wire:click.debounce="enableAddStockModal({{ $order->id }})" type="button">
                                    ...
                                    <button wire:click.debounce="confirmDeleteProduct({{ $order->id }})" class="text-red-400" type="button">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
