<section class="grid grid-cols-1 md:grid-cols-3 md:gap-5">
    ...
    <x-ui.loading-spinner wire:loading.flex wire:target="confirmDeleteFeatureBox, enableFeatureBoxEditMode, updateFeatureBox, updateFeatureBox, cancelFeatureBoxEditMode, createFeatureBox, removeImage" />
</section>
