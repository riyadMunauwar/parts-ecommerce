<nav class="fixed left-0 right-0 bottom-0 h-8 bg-white py-2 flex justify-evenly">
    <a href="" class="relative inline-flex items-center py-2.5 text-sm font-medium text-center">
        <span>
