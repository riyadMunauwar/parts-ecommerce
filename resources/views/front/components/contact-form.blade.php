                ...
                <div class="mt-6 space-y-8 md:mt-8">
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">
                            {{ config('setting')->contact_page_address ?? '' }}
                        </span>
                    </p>
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">
                            {{ config('setting')->contact_page_phone ?? '' }}
                        </span>
                    </p>
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">
                        {{ config('setting')->contact_page_email ?? '' }}
                        </span>
                    </p>
                </div>
                ...
                <div class="mt-6 w-80 md:mt-8">
                    ...
                    <div class="flex mt-4 -mx-1.5 ">
                        @foreach($socialLinks as $socialLink)
                            <a href="$socialLink->link" target="_blank" class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" href="#">
                                <img class="w-10 h-10 object-contain" src="{{ $socialLink->iconUrl() }}" alt="">
                            </a>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="w-full px-8 py-10 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl dark:bg-gray-900 lg:max-w-xl shadow-gray-300/50 dark:shadow-black/50">
                    ...
                    <form wire:submit.prevent="sendMessage" class="mt-6">
                        <div class="flex-1">
                            ...
                            <input wire:model.debounce="first_name" type="text" placeholder="John Doe" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                        </div>

                        <div class="flex-1 mt-6">
                            <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200">Email address</label>
                            <input wire:model.debounce="email" type="email" placeholder="johndoe@example.com" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                        </div>

                        <div class="w-full mt-6">
                            <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200">Message</label>
                            <textarea wire:model.debounce="message" class="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md md:h-48 dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Message"></textarea>
                        </div>
