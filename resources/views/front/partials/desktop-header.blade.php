        ...
        <div class="max-w-3xl mx-auto px-5 py-5 flex">
            <form class="flex items-center flex-grow">
                ...
                <div class="relative w-full">
                    ...
                    <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300  text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 w-full pl-10 p-3" placeholder="Search" required="">
                </div>
            </form>
